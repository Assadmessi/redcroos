...
class MockMembers {
  ...
  static List<Member> get all => [
    ...
    Member(
      ...
      emergencyPhone: '',
      skillIds: const ['sk1', 'sk3'],
      youthGroup: YouthGroup.disasterManagement, youthGroupRole: YouthGroupRole.leader,
      role: UserRole.officer,
      gender: Gender.male,
    ...
    Member(
      ...
      emergencyPhone: '',
      skillIds: const ['sk1', 'sk3'],
      youthGroup: YouthGroup.firstAid, youthGroupRole: YouthGroupRole.member,
      role: UserRole.dutyOfficer,
      gender: Gender.male,
    ...
    Member(
      ...
      emergencyPhone: '',
      skillIds: const ['sk1', 'sk3'],
      youthGroup: YouthGroup.bloodDonations, youthGroupRole: YouthGroupRole.member,
      role: UserRole.dutyOfficer,
      gender: Gender.male,
    ...
    Member(
      ...
      phone: '', email: '', address: '', emergencyContact: '', emergencyPhone: '',
      skillIds: const ['sk5', 'sk1'], role: UserRole.seniorOfficer, gender: Gender.female,
    ),
    ...
    Member(
      ...
      emergencyPhone: '',
      skillIds: const ['sk1'],
      youthGroup: YouthGroup.firstAid, youthGroupRole: YouthGroupRole.leader,
      role: UserRole.dutyOfficer,
      gender: Gender.female,
    ...
    Member(
      ...
      skillIds: const ['sk1'], role: UserRole.member, gender: Gender.female,
    ...
    Member(id: 'm325', memberNo: 'RC-325', nameEn: '', nameMm: '', rank: MemberRank.deputySectionLeader, unitType: UnitType.section, companyNo: 3, platoonNo: 2, sectionNo: 2, status: MemberStatus.active, bloodType: BloodType.OP, joinDate: DateTime(2020,1,1), dateOfBirth: DateTime(1990,1,1), phone: '', email: '', address: '', emergencyContact: '', emergencyPhone: '', skillIds: const ['sk1'], role: UserRole.member, gender: Gender.female),
    ...
    Member(
      ...
      skillIds: const [],
      youthGroup: YouthGroup.infoAndCommunications, youthGroupRole: YouthGroupRole.member, role: UserRole.member, gender: Gender.female,
    ...
    Member(
      ...
      skillIds: const [],
      youthGroup: YouthGroup.youthGroup, youthGroupRole: YouthGroupRole.member, role: UserRole.member, gender: Gender.female,
...
class MockDuties {
  ...
  static List<Duty> _seedDuties() {
    ...
    return [
      ...
      // Completed emergency duty — disaster-level, report submitted
      // but not yet approved, eligible for escalation
      Duty(
        id: 'duty8',
        title: 'Apartment Fire — Bo Soon Pat Street',
        titleMm: 'ဗိုလ်စွန်းပတ်လမ်း မီးလောင်မှု',
        type: DutyType.emergency,
        scale: DutyScale.regular,
        date: d(-1),
        startHour: 14, startMinute: 20,
        endHour: 17, endMinute: 0,
        location: 'Bo Soon Pat Street, Botahtaung',
        members: [
          DutyMember(
            memberId: 'm106', roleInDuty: DutyRoleInDuty.commander,
            status: DutyAssignmentStatus.accepted,
            assignedAt: d(-1), respondedAt: d(-1), checkedInAt: d(-1),
          ),
          DutyMember(
            memberId: 'm107', roleInDuty: DutyRoleInDuty.member,
            status: DutyAssignmentStatus.accepted,
            assignedAt: d(-1), respondedAt: d(-1), checkedInAt: d(-1),
          ),
          DutyMember(
            memberId: 'm118', roleInDuty: DutyRoleInDuty.member,
            status: DutyAssignmentStatus.accepted,
            assignedAt: d(-1), respondedAt: d(-1), checkedInAt: d(-1),
          ),
        ],
        status: DutyStatus.completed,
        description: 'Third-floor apartment fire, first responders arrived ahead of the fire department.',
        createdByMemberId: 'm106',
        isDisasterLevel: true,
        report: 'Arrived on scene at 14:20 following a call from a neighbor. Assisted evacuating residents from the affected and adjacent units while waiting for the fire department. No serious injuries reported, two residents treated for minor smoke inhalation. Scene handed over to fire department at 15:10, remained on standby for medical support until 17:00.',
        reportSubmittedByMemberId: 'm106',
        reportSubmittedAt: d(-1),
      ),

      // Upcoming administrative duty — Company 1
      Duty(
        id: 'duty9',
        title: 'Monthly Equipment & Records Audit',
        titleMm: 'လစဉ် ပစ္စည်းနှင့် မှတ်တမ်းစစ်ဆေးခြင်း',
        type: DutyType.administrative,
        scale: DutyScale.regular,
        date: d(5),
        startHour: 9, startMinute: 0,
        ...
        status: DutyStatus.upcoming,
        description: 'Routine equipment inventory check and records filing update.',
      ),

      // Upcoming "other" duty — Company 3
      Duty(
        id: 'duty10',
        title: 'Community Outreach — Relief Supplies Sorting',
        titleMm: 'အသိုင်းအဝိုင်း ဆက်ဆံရေး — ကယ်ဆယ်ရေးပစ္စည်း စိစစ်ခွဲခြားခြင်း',
        type: DutyType.other,
        scale: DutyScale.regular,
        date: d(6),
        startHour: 13, startMinute: 0,
        endHour: 16, endMinute: 0,
        location: 'Company 3 Office',
        members: [
          accepted('m302', DutyRoleInDuty.commander),
          accepted('m320', DutyRoleInDuty.member),
          pending('m324', DutyRoleInDuty.member),
        ],
        status: DutyStatus.upcoming,
        description: 'Sorting and packing donated relief supplies ahead of distribution.',
      ),
    ];
  }
...
class MockMeetings {
  ...
  static List<Meeting> _seedMeetings() {
    ...
    return [
      ...
      // Minutes drafted, awaiting Brigade leadership sign-off — Company 3
      Meeting(
        id: 'meeting4',
        title: 'Company 3 Quarterly Readiness Review',
        titleMm: 'တပ်ခွဲ (၃) သုံးလပတ် အသင့်ရှိမှု ပြန်လည်သုံးသပ်ခြင်း',
        type: MeetingType.general,
        date: d(-6),
        timeHour: 13, timeMinute: 0,
        location: 'Company 3 Office',
        invitedMemberIds: const ['m302', 'm324', 'm326', 'm327'],
        attendedMemberIds: const ['m302', 'm324', 'm326'],
        excusedMemberIds: const ['m327'],
        absentMemberIds: const [],
        status: MeetingStatus.minutesDrafted,
        tasks: [
          MeetingTask(
            id: 'task4_1', meetingId: 'meeting4',
            title: 'Update Section 2 duty roster with new availability',
            assignedMemberId: 'm324',
            dueDate: d(4),
            isCompleted: false,
            isVerified: false,
          ),
        ...
        meetingNumber: 5,
        meetingYear: now.year,
        organizerMemberId: 'm302',
        recorderMemberId: 'm324',
        agendaItems: [
          AgendaItem(
            id: 'agenda4_1', meetingId: 'meeting4', order: 1,
            topic: 'Section 2 Duty Roster Gaps',
            presenterMemberId: 'm324',
            discussionEntries: [
              DiscussionEntry(id: 'disc7', speakerMemberId: 'm324', comment: 'Two weekend slots are consistently uncovered — need volunteers or a rotation change.'),
              DiscussionEntry(id: 'disc8', speakerMemberId: 'm302', comment: 'Will check with Section 1 about a temporary cross-cover arrangement.'),
            ],
            decisions: const [
              DecisionEntry(id: 'dec5', decisionText: 'Section 2 Deputy Leader to revise the weekend roster within a week.', approvedByMemberId: 'm302'),
            ],
          ),
        ],
        minutes: 'Meeting opened on time. Main item was the Section 2 weekend roster gap. Roster revision assigned, see tasks. Awaiting Brigade Office sign-off before publishing.',
      ),

      // Minutes signed by Brigade leadership, not yet published — Brigade-wide
      Meeting(
        id: 'meeting5',
        title: 'Annual Training Calendar Planning',
        titleMm: 'နှစ်စဉ် လေ့ကျင့်ရေး ပြက္ခဒိန် စီစဉ်ခြင်း',
        type: MeetingType.officer,
        date: d(-12),
        timeHour: 10, timeMinute: 30,
        location: 'Brigade Office Conference Room',
        invitedMemberIds: const ['m1', 'm2', 'm101', 'm301'],
        attendedMemberIds: const ['m1', 'm2', 'm101', 'm301'],
        excusedMemberIds: const [],
        absentMemberIds: const [],
        status: MeetingStatus.signed,
        tasks: [
          MeetingTask(
            id: 'task5_1', meetingId: 'meeting5',
            title: 'Circulate draft training calendar to all companies',
            assignedMemberId: 'm2',
            dueDate: d(-2),
            isCompleted: true,
            completedAt: d(-3),
        ...
        agendaItems: [
          AgendaItem(
            id: 'agenda5_1', meetingId: 'meeting5', order: 1,
            topic: 'Q3/Q4 Class Schedule Draft',
            presenterMemberId: 'm2',
            discussionEntries: [
              DiscussionEntry(id: 'disc9', speakerMemberId: 'm2', comment: 'Proposing First Aid Level 2 in Q3 and Disaster Management in Q4, brigade-wide.'),
              DiscussionEntry(id: 'disc10', speakerMemberId: 'm301', comment: 'Company 3 requests an additional CPR refresher slot given recent expirations.'),
            ],
            decisions: const [
              DecisionEntry(id: 'dec6', decisionText: 'Add a CPR refresher session to Q3, alongside First Aid Level 2.', approvedByMemberId: 'm1'),
            ],
          ),
        ],
        minutes: 'Annual training calendar discussed and finalized in draft form. CPR refresher added to Q3 at Company 3\'s request. Signed by Brigade Commander, ready to publish to all companies.',
      ),

      // Scheduled committee meeting — for the active investigation committee
      Meeting(
        id: 'meeting6',
        title: 'Investigation Committee Coordination',
        titleMm: 'စုံစမ်းစစ်ဆေးရေး ကော်မတီ ညှိနှိုင်းအစည်းအဝေး',
        type: MeetingType.committee,
        date: d(3),
        timeHour: 11, timeMinute: 0,
        location: 'Brigade Office Meeting Room',
        invitedMemberIds: const ['m2', 'm3', 'm101'],
        attendedMemberIds: const [],
        status: MeetingStatus.scheduled,
        tasks: const [],
        createdAt: d(-1),
        ...
        meetingYear: now.year,
        organizerMemberId: 'm2',
        recorderMemberId: 'm101',
        agendaItems: const [
          AgendaItem(
            id: 'agenda6_1', meetingId: 'meeting6', order: 1,
            topic: 'Case INV-2026-01 — Committee Progress Check-in',
            presenterMemberId: 'm2',
          ),
        ],
      ),

      // In-progress youth wing leaders meeting — Brigade-wide
      Meeting(
        id: 'meeting7',
        title: 'Youth Wing Leaders Coordination',
        titleMm: 'လူငယ်အဖွဲ့ ခေါင်းဆောင်များ ညှိနှိုင်းအစည်းအဝေး',
        type: MeetingType.youthLeaders,
        date: d(0),
        timeHour: 15, timeMinute: 0,
        location: 'Brigade Office Conference Room',
        invitedMemberIds: const ['m103', 'm320'],
        attendedMemberIds: const ['m103', 'm320'],
        status: MeetingStatus.inProgress,
        tasks: const [],
        createdAt: d(-2),
        meetingNumber: 1,
        meetingYear: now.year,
        organizerMemberId: 'm103',
        recorderMemberId: 'm103',
        agendaItems: [
          AgendaItem(
            id: 'agenda7_1', meetingId: 'meeting7', order: 1,
            topic: 'Q3 Youth Wing Activity Planning',
            presenterMemberId: 'm320',
            discussionEntries: [
              DiscussionEntry(id: 'disc11', speakerMemberId: 'm320', comment: 'Proposing a First Aid awareness session for the youth group ahead of the school term.'),
              DiscussionEntry(id: 'disc12', speakerMemberId: 'm103', comment: 'Disaster Management group can co-host with a basic preparedness demo.'),
            ],
          ),
        ],
      ),

      // Completed youth wing general meeting — Brigade-wide
      Meeting(
        id: 'meeting8',
        title: 'Youth Wing Quarterly Meeting',
        titleMm: 'လူငယ်အဖွဲ့ သုံးလပတ် အစည်းအဝေး',
        type: MeetingType.youthGroup,
        date: d(-18),
        timeHour: 14, timeMinute: 0,
        location: 'Brigade Office Conference Room',
        invitedMemberIds: const ['m103', 'm107', 'm119', 'm320', 'm326', 'm327'],
        attendedMemberIds: const ['m103', 'm107', 'm320', 'm326', 'm327'],
        excusedMemberIds: const ['m119'],
        absentMemberIds: const [],
        status: MeetingStatus.published,
        tasks: const [],
        createdAt: d(-21),
        ...
        meetingYear: now.year,
        organizerMemberId: 'm103',
        recorderMemberId: 'm320',
        approvedByMemberId: 'm2',
        agendaItems: [
          AgendaItem(
            id: 'agenda8_1', meetingId: 'meeting8', order: 1,
            topic: 'First Aid Awareness Session — Recap',
            presenterMemberId: 'm320',
            discussionEntries: [
              DiscussionEntry(id: 'disc13', speakerMemberId: 'm320', comment: 'Session was well attended, around 40 students from nearby schools.'),
              DiscussionEntry(id: 'disc14', speakerMemberId: 'm326', comment: 'Several students asked about joining the youth group permanently.'),
            ],
            decisions: const [
              DecisionEntry(id: 'dec7', decisionText: 'Prepare a simple youth group recruitment flyer for interested students.', approvedByMemberId: 'm103'),
            ],
          ),
        ],
        minutes: 'Recap of the First Aid awareness session held last quarter — well received, with interest from several students in joining the youth group. Flyer preparation assigned.',
      ),

      // Scheduled custom meeting — Company 1, a one-off tabletop exercise
      Meeting(
        id: 'meeting9',
        title: 'Disaster Response Tabletop Exercise',
        titleMm: 'ဘေးအန္တရာယ် တုံ့ပြန်မှု စားပွဲတင် လေ့ကျင့်ခန်း',
        type: MeetingType.custom,
        date: d(10),
        timeHour: 9, timeMinute: 0,
        location: 'Company 1 Office',
        invitedMemberIds: const ['m101', 'm102', 'm103', 'm106'],
        attendedMemberIds: const [],
        status: MeetingStatus.scheduled,
        tasks: const [],
        createdAt: d(-1),
        ...
        agendaItems: const [
          AgendaItem(
            id: 'agenda9_1', meetingId: 'meeting9', order: 1,
            topic: 'Scenario Walkthrough — Flash Flood Response',
            presenterMemberId: 'm103',
          ),
        ],
      ),
    ];
...
class MockClasses {
  ...
  static List<TrainingClass> _seedClasses() {
    ...
    return [
      ...
      // Draft class — still being planned, not yet open for
      // enrollment. No committee formed yet, no timetable finalized.
      TrainingClass(
        id: 'class3',
        title: 'Disaster Management Advanced Course',
        titleMm: 'ဘေးအန္တရာယ် စီမံခန့်ခွဲမှု အဆင့်မြင့် သင်တန်း',
        type: ClassType.workshop,
        category: 'Disaster',
        description: 'Advanced disaster response coordination, building on the Fundamentals course — still being scoped.',
        instructorId: 'm302',
        instructorName: 'Daw Lin Let Tara Ya',
        isExternalInstructor: false,
        startDate: d(45),
        endDate: d(47),
        location: 'Company 3 Office',
        maxParticipants: 20,
        enrolledMemberIds: const [],
        status: ClassStatus.draft,
        requiredSkillIds: const ['sk4'], // Disaster Management
        awardedSkillIds: const [],
      ...
      // Full class — enrollment cap reached, registration closed.
      TrainingClass(
        id: 'class4',
        title: 'CPR Certification Workshop',
        titleMm: 'CPR လက်မှတ် သင်တန်း',
        type: ClassType.workshop,
        category: 'Medical',
        description: 'Hands-on CPR certification workshop, capped to a small group for proper supervision.',
        instructorId: 'm103',
        instructorName: 'U Hla Myint Oo',
        isExternalInstructor: false,
        startDate: d(10),
        endDate: d(10),
        location: 'Company 1 Training Hall',
        maxParticipants: 4,
        enrolledMemberIds: const ['m106', 'm107', 'm118', 'm119'],
        status: ClassStatus.full,
        requiredSkillIds: const [],
        awardedSkillIds: const ['sk3'], // CPR Certified
        issuesCertificate: true,
        hasCommittee: false,
        committee: const [],
        timetable: [
          ClassSession(
            id: 'session4_1', classId: 'class4', sessionNumber: 1,
            topic: 'CPR & AED Certification', date: d(10),
            startHour: 9, startMinute: 0, endHour: 13, endMinute: 0,
            location: 'Company 1 Training Hall', facilitator: 'U Hla Myint Oo',
            status: 'scheduled',
          ),
        ],
      ),

      // Ongoing class — currently in progress, spanning today.
      TrainingClass(
        id: 'class5',
        title: 'Leadership Development Program',
        titleMm: 'ခေါင်းဆောင်မှု ဖွံ့ဖြိုးတိုးတက်ရေး အစီအစဉ်',
        type: ClassType.workshop,
        category: 'Administrative',
        description: 'Brigade-wide leadership development covering team management, decision-making, and mentorship.',
        instructorId: 'm1',
        instructorName: 'Daw Khin Than Soe',
        isExternalInstructor: false,
        startDate: d(-1),
        endDate: d(1),
        location: 'Brigade Office Conference Room',
        maxParticipants: 12,
        enrolledMemberIds: const ['m103', 'm118', 'm320', 'm326'],
        status: ClassStatus.ongoing,
        requiredSkillIds: const [],
        awardedSkillIds: const ['sk5'], // Leadership
        issuesCertificate: true,
        hasCommittee: true,
        committee: const [
          ClassCommitteeMember(memberId: 'm2', role: 'Committee Head'),
          ClassCommitteeMember(memberId: 'm101', role: 'Coordinator'),
        ],
        timetable: [
          ClassSession(
            id: 'session5_1', classId: 'class5', sessionNumber: 1,
            topic: 'Team Management Fundamentals', date: d(-1),
            startHour: 9, startMinute: 0, endHour: 12, endMinute: 0,
            location: 'Brigade Office Conference Room', facilitator: 'Daw Khin Than Soe',
            status: 'completed',
          ),
          ClassSession(
            id: 'session5_2', classId: 'class5', sessionNumber: 2,
            topic: 'Decision-Making Under Pressure', date: d(0),
            startHour: 9, startMinute: 0, endHour: 12, endMinute: 0,
            location: 'Brigade Office Conference Room', facilitator: 'Daw Khin Than Soe',
            status: 'scheduled',
          ),
          ClassSession(
            id: 'session5_3', classId: 'class5', sessionNumber: 3,
            topic: 'Mentorship & Succession Planning', date: d(1),
            startHour: 9, startMinute: 0, endHour: 12, endMinute: 0,
            location: 'Brigade Office Conference Room', facilitator: 'Daw Khin Than Soe',
            status: 'scheduled',
          ),
      ...
      // Archived class — completed long ago, moved out of active view.
      TrainingClass(
        id: 'class6',
        title: 'Basic First Aid Certification — 2025 Cohort',
        titleMm: 'အသက်ဆယ်ယူ အခြေခံ လက်မှတ် — ၂၀၂၅ ပညာသင်နှစ်',
        type: ClassType.workshop,
        category: 'Medical',
        description: 'Foundational First Aid Level 1 certification course, run for Company 3.',
        instructorId: 'm320',
        instructorName: 'Ma Su Wai Hnin',
        isExternalInstructor: false,
        startDate: d(-200),
        endDate: d(-198),
        location: 'Company 3 Office',
        maxParticipants: 15,
        enrolledMemberIds: const ['m324', 'm326', 'm327'],
        status: ClassStatus.archived,
        requiredSkillIds: const [],
        awardedSkillIds: const ['sk1'], // First Aid Level 1
        issuesCertificate: true,
        hasCommittee: false,
        committee: const [],
        timetable: [
          ClassSession(
            id: 'session6_1', classId: 'class6', sessionNumber: 1,
            topic: 'First Aid Basics & Bandaging', date: d(-200),
            startHour: 13, startMinute: 0, endHour: 16, endMinute: 0,
            location: 'Company 3 Office', facilitator: 'Ma Su Wai Hnin',
            status: 'completed',
          ),
          ClassSession(
            id: 'session6_2', classId: 'class6', sessionNumber: 2,
            topic: 'CPR Basics & Final Assessment', date: d(-198),
            startHour: 13, startMinute: 0, endHour: 16, endMinute: 0,
            location: 'Company 3 Office', facilitator: 'Ma Su Wai Hnin',
            status: 'completed',
          ),
...
class MockClosureReportEditRequests {
  ...
  static List<ClosureReportEditRequest> _seedRequests() {
    final now = DateTime.now();
    return [
      // m102 (class2's instructor — no committee on this class, so
      // the instructor is the sole eligible editor) requesting to
      // fix the Issues/Recommendations text on the now-locked
      // closure report (closure1). m102 isn't Master Access, so this
      // genuinely needs approval — tests the Master Access review
      // screen and the per-section approval.
