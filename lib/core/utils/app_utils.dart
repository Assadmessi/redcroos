...
class AppStatusHelper {
  ...
  static Color notificationTypeColor(NotificationType t) {
    switch (t) {
      ...
      case NotificationType.standby: return AppColors.warning;
      case NotificationType.availability: return AppColors.info;
    }
  }
  ...
  static IconData notificationTypeIcon(NotificationType t) {
    switch (t) {
      ...
      case NotificationType.standby: return Icons.pause_circle_rounded;
      case NotificationType.availability: return Icons.event_available_rounded;
    }
  }
