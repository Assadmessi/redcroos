...
class AppFormatters {
  ...
  static String time(int hour, int minute) => '${hour.toString().padLeft(2, '0')}:${minute.toString().padLeft(2, '0')}';;
  static String timeRange(int sh, int sm, int? eh, int? em) => (eh != null && em != null) ? '${time(sh,sm)} — ${time(eh,em)}' : time(sh, sm);
